...
func TestSavedModel(t *testing.T) {
	tags := []string{"serve"}
	bundle, err := LoadSavedModel("testdata/saved_model/half_plus_two/00000123", tags, nil)
	if err != nil {
...
func TestSavedModelWithEmptyTags(t *testing.T) {
	tags := []string{}
	_, err := LoadSavedModel("testdata/saved_model/half_plus_two/00000123", tags, nil)
	if err == nil {
